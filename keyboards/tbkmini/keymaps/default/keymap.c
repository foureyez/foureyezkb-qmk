...
[_WIN] = LAYOUT_split_3x6_3(
  ...
  _______ , KC_A , KC_S , KC_D           , KC_F   , KC_G    ,     KC_H      , KC_J    , KC_K    , KC_L   , KC_SCLN , VIM_CMD,
...
[_COLEMAK] = LAYOUT_split_3x6_3(
  ...
  _______ , KC_A , KC_R , KC_S           , KC_T   , KC_D    ,     KC_H      , KC_N    , KC_E           , KC_I   , KC_O    , VIM_CMD,
...
[_SPCL] = LAYOUT_split_3x6_3(
  ...
  _______ , KC_UNDS , KC_LBRC , LCTL(KC_C) , KC_RBRC  , KC_QUOT   ,     XXXXXXX , KC_7    , KC_8    , KC_9 , XXXXXXX , _______ ,
                                VIM_CLOSE  , VIM_SAVE , MO(_DUAL) ,     _______ , _______ , _______
),
...
[_DUAL] = LAYOUT_split_3x6_3(
  QK_BOOT , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,     KC_F10  , KC_F1   , KC_F2   , KC_F3 , XXXXXXX , TG(_MAC)    ,
  XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,     KC_F11  , KC_F4   , KC_F5   , KC_F6 , XXXXXXX , TG(_COLEMAK),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        case VIM_CLOSE:
            if (record->event.pressed) {
                send_string(SS_LCTL("c") ":q" SS_TAP(X_ENTER));
                return false;
            }
            break;
    }
